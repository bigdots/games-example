...
import { _decorator, Component, Node, SkeletalAnimationComponent, RigidBodyComponent, BoxColliderComponent, AnimationClip, SkeletalAnimationState, Vec3, Prefab, AnimationComponent, Quat, Sprite, Game } from 'cc';
...
export class Boss extends Component {
    ...
    public rigidCom: RigidBodyComponent = null!;

    @property(BoxColliderComponent)
    public boxColliderCom: BoxColliderComponent = null!;
    ...
    private _aniComComa: AnimationComponent = null!;//昏迷动画
    ...
    private _showStar () {
        if (this._aniComComa) {
            ...
            resourceUtil.loadEffectRes("star/star01").then((prefab: any)=>{
                ...
                this._aniComComa = ndEffect.getComponent(AnimationComponent) as AnimationComponent;
                this._aniComComa.play("star01");
            })
        }
    }
