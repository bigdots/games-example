...
export class GameManager extends Component {
    ...
    private _aniComSkyBox: AnimationComponent = null!;//天空盒动画
    ...
    public static resetAniState (aniCom: AnimationComponent, aniName: string) {
        aniCom.play(aniName);   
    }
    ...
    public update (deltaTime: number) {
        ...
        if (GameManager.scriptPlayer && GameManager.scriptPlayer.node && !GameManager.isGameOver) {
            ...
            this.ndSkyBox.setWorldPosition(this._oriSkyBoxWorPos.clone().add3f(0, 0, v3_offsetWorPosSkyBox.z));

            Vec3.subtract(v3_offsetWorPosWater, playerWorPos, this._oriWaterWorPos);
            this.ndWater.setWorldPosition(this._oriWaterWorPos.clone().add3f(0, 0, v3_offsetWorPosWater.z));

            Vec3.subtract(v3_offsetWorPosMainLight, playerWorPos, this._oriMainLightWorPos);
            this.ndLight.setWorldPosition(this._oriMainLightWorPos.clone().add3f(0, 0, v3_offsetWorPosMainLight.z + 2));
        }
