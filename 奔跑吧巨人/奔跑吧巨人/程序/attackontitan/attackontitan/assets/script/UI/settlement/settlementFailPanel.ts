...
import { SpriteComponent, UITransformComponent, math, Size, clamp } from 'cc';
...
export class SettlementFailPanel extends Component {
    ...
    public spIconRevive: SpriteComponent = null!;

    @property(SpriteComponent)
    public spIconBeatEnemy: SpriteComponent = null!;
    ...
    public set countDown (value: number) {
        ...
        this.ndMask.getComponent(UITransformComponent)?.setContentSize(new Size(300, this._curMaskHeight));
