...
import { ButtonComponent, SpriteComponent, SpriteFrame, Prefab, EventHandler, PageView, PageViewIndicatorComponent, PageViewComponent, instantiate, profiler, random, PolygonCollider2D } from 'cc';
...
export class ShopPanel extends Component {
    ...
    public lbDiamondRandomSkin: LabelComponent = null!;//随机皮肤价格

    @property(LabelComponent)
    public lbDiamondReceiveNum: LabelComponent = null!;//随机钻石领取的数量

    @property(SpriteComponent)
    public spBtnHat: SpriteComponent = null!;//帽子按钮sprite组件

    @property(SpriteComponent)
    public spBtnShoes: SpriteComponent = null!;//鞋子按钮sprite组件
    ...
    @property(SpriteComponent)
    public spPayIconReceiveDiamond: SpriteComponent = null!; //获取钻石的视频图标
    ...
    public btnRandomSkin: ButtonComponent = null!;//获取钻石皮肤按钮
    ...
    public pageViewComHat: PageViewComponent = null!;//帽子页面组件

    @property(PageViewComponent)
    public pageViewShoes: PageViewComponent = null!;//鞋子页面组件
    ...
    @property(SpriteComponent)
    public spRandomSkin: SpriteComponent = null!;//随机皮肤按钮sprite
