...
import { _decorator, Component, Node, SystemEventType, systemEvent, EventKeyboard, EventTouch, LabelComponent, ProgressBarComponent, Vec3, view, tween, math, misc, AnimationComponent, SpriteFrame, SpriteComponent, Game, Touch, find, clamp, quat, Quat } from 'cc';
...
export class ParkourPanel extends Component {
    ...
    @property(LabelComponent)
    public lbPeople: LabelComponent = null!;//小人数量

    @property(LabelComponent)
    public lbDiamond: LabelComponent = null!;//钻石数量

    @property(LabelComponent)
    public lbKey: LabelComponent = null!; //钥匙数量
    
    @property(ProgressBarComponent)
    public progressBarCountdown: ProgressBarComponent = null!;//倒计时进度条
    ...
    @property(ProgressBarComponent)
    public pbNormalPlayerBlood: ProgressBarComponent = null!;//普通关卡玩家血条进度条

    @property(ProgressBarComponent)
    public pbNormalEnemyBlood: ProgressBarComponent = null!;//普通关卡敌人血条进度条

    @property(ProgressBarComponent)
    public pbNormalCrazyClick: ProgressBarComponent = null!;//普通关卡刺激点击进度

    @property(Node)
    public ndFightBoss: Node = null!;//boss关卡父节点

    @property(ProgressBarComponent)
    public pbPlayerBlood: ProgressBarComponent = null!;//boss关卡玩家血条进度条

    @property(ProgressBarComponent)
    public pbBossBlood: ProgressBarComponent = null!;//boss关卡敌人血条进度条
    ...
    @property(LabelComponent)
    public lbScoreNum: LabelComponent = null!;//分数文字

    @property(AnimationComponent)
    public aniScore: AnimationComponent = null!;//分数动画

    @property(Node)
    public ndEnergyProgress: Node = null!;//能量进度节点

    @property(ProgressBarComponent)
    public pbEnergy: ProgressBarComponent = null!;//能量进度条
    ...
    public spEnergyBar: SpriteComponent = null!;//能量进度条子节点
    ...
    private _onTouchMove (event: EventTouch) {
        ...
        if (GameManager.gameStatus === constant.GAME_STATUS.RUN && GameManager.isGameStart) {
                ...
                if (GameManager.scriptPlayer.isArriveEnd && !GameManager.isGameOver) {
                    if (this.bossStatus === constant.BOSS_STATUS.HIDE) {
                        if (this.ndArrow.active) {
                            ...
                            let contentSize = view.getCanvasSize().x;
