import { AnimationComponent, find, Vec3, instantiate, SpriteFrame, profiler } from 'cc';
...
import { _decorator, Component, Node, LabelComponent, SpriteComponent, UITransformComponent, ButtonComponent, size, random, Prefab } from 'cc';
...
export class SettlementSuccessPanel extends Component {
    ...
    public lbPeople: LabelComponent = null!;

    @property(LabelComponent)
    public lbDiamond: LabelComponent = null!;

    @property(LabelComponent)
    public lbMultiple: LabelComponent = null!;
    ...
    public spIcon: SpriteComponent = null!;//付费按钮图标

    @property(LabelComponent)
    public lbDiamondNormal: LabelComponent = null!;//普通领取 钻石数量

    @property(LabelComponent)
    public lbDiamondDouble: LabelComponent = null!;//双倍领取 钻石数量

    @property(LabelComponent)
    public lbBtnMultiple: LabelComponent = null!;//按钮上的倍数

    @property(Node)
    public ndArrow: Node = null!;//箭头节点

    @property(SpriteComponent)
    public spSkinIcon: SpriteComponent = null!;//皮肤图标

    @property(UITransformComponent)
    public UIComImgGray: UITransformComponent = null!;//皮肤灰色遮罩

    @property(LabelComponent)
    public lbSkinProgress: LabelComponent = null!;//皮肤收集进度
    ...
    @property(SpriteComponent)
    public spRewardIcon: SpriteComponent = null!;//奖励图标组件
    ...
    @property(LabelComponent)
    public lbRewardNum: LabelComponent = null!;//奖励数量范围

    @property(AnimationComponent)
    public aniLottery: AnimationComponent = null!;//翻倍奖励动画
    ...
    private _showBox () {
        ...
        let aniCom = this._ndBoxReward.getComponentInChildren(AnimationComponent) as AnimationComponent;
        this.scheduleOnce(()=>{
