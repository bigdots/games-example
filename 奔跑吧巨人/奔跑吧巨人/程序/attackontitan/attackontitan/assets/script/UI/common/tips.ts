...
import { _decorator, Component, Node, LabelComponent, Vec3, tween, UIComponent, UITransform, UIOpacityComponent, isValid, UIOpacity, SpriteFrame, SpriteComponent, UITransformComponent, Color, find, Game, Sprite, color } from 'cc';
