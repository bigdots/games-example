...
import { _decorator, Component, Node, SpriteComponent, SpriteFrame, LabelComponent, ButtonComponent } from 'cc';
...
export class ShoesItem extends Component {
    ...
    public spItemBg: SpriteComponent = null!;//底图sprite
    ...
    @property(SpriteComponent)
    public spShoesIcon: SpriteComponent = null!;//鞋子图标

    @property(Node)
    public ndPay: Node = null!; //广告内容节点

    @property(SpriteComponent)
    public spPayIcon: SpriteComponent = null!;//视频广告icon节点

    @property(LabelComponent)
    public lbTxt: LabelComponent = null!;//广告次数文本节点

    @property(ButtonComponent)
    public btnItem: ButtonComponent = null!;
