...
import { Vec3, SpriteComponent, AnimationComponent, LabelComponent, find, Prefab } from 'cc';
...
export class BoxItem extends Component {
    ...
    public aniComLight: AnimationComponent = null!;

    @property(LabelComponent)
    public lbDiamond: LabelComponent = null!;

    @property(SpriteComponent)
    public spSkin: SpriteComponent = null!;
    ...
    @property(AnimationComponent)
    public aniComBox: AnimationComponent = null!;
    ...
    public onBoxItemClick () {
        if (!this._isOpen && this._scriptBoxPanel.keyNum > 0) {
            ...
            this.aniComLight.on(AnimationComponent.EventType.FINISHED, ()=>{
            ...
            this.aniComBox.once(AnimationComponent.EventType.FINISHED, ()=>{
                this.scheduleOnce(()=>{
