...
import { _decorator, Component, Node, SpriteFrame, SpriteComponent, Label, LabelComponent } from 'cc';
...
export class BoxPanel extends Component {
    ...
    public spPayIconKey: SpriteComponent = null!;//获取钥匙视频图标

    @property(SpriteComponent)
    public spPayIconDouble: SpriteComponent = null!;//双倍奖励视频图标

    @property(SpriteComponent)
    public spBestReward: SpriteComponent = null!;//最佳奖品图标

    @property(LabelComponent)
    public lbBestRewardNum: LabelComponent = null!;//最佳奖励数量

    @property(LabelComponent)
    public lbDouble: LabelComponent = null!;//双倍领取钻石数量

    @property(LabelComponent)
    public lbNormal: LabelComponent = null!;//普通领取上钻石量
    ...
    public useKey () {
        ...
        this.ndKeyList.children.forEach((item: Node, index: number, arr: any)=>{
            ...
            let spCom = element.getComponent(SpriteComponent) as SpriteComponent;
    ...
    private _getKey () {
        ...
        this.ndKeyList.children.forEach((item: Node)=>{
            let spCom = item.getComponent(SpriteComponent) as SpriteComponent;
            spCom.spriteFrame = this.sfKeyEnable;
        })
    }
